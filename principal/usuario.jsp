											...
											<div class="col-sm-12">
												...
												<div class="card">
													<div class="card-block">
														<h4 class="sub-title">Cadastro de Novo Usuário</h4>
													...
													<c:forEach items='${modelLogins}' var='ml'>
														<tr>
															...
															<td><a class="btn btn-success"
																href="<%= request.getContextPath() %>/ServletUsuarioController?acao=buscarEditar&id=${ml.id}">Editar</a></td>
														</tr>
													</c:forEach>
												</tbody>
											</table>
											...
											$('#tabelaresultados > tbody')
													.append(
															'<tr> <td>'
																	...
																	+ json[p].id
																	+ ')" type="button" class="btn btn-info">Editar</button></td></tr>');
										}
